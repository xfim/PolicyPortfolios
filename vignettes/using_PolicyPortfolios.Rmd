...
Two fake dataset to show the possibilities of the package has been created, and they can be accessed using the `data(PolicyPortfolio)` call.
...
[consensus](http://publicpolicy-knill.org/forschung/consensus/) research
project. [Guidelines](http://www.gsi.uni-muenchen.de/lehreinheiten/ls_emp_theo/forschung/dokumente/guidelinesconsensus.pdf) for external experts to collect data on
social and environmental policies are available, as well as the [coding
manual](http://www.gsi.uni-muenchen.de/lehreinheiten/ls_emp_theo/forschung/dokumente/codingmanual.pdf).
...
# Development
The development of `PolicyPortfolios` (track changes, propose improvements, report bugs) can be followed at [https://github.com/xfim/PolicyPortfolios](github).
